...
namespace HostAppInPanelLib
{
    public static class WindowHelper
    {
        ...
        public static void MakeExternalWindowBorderless(IntPtr mainWindowHandle, int x, int y, int width, int htight)
        {
            var style = GetWindowLongPtr(mainWindowHandle, GwlStyle);
            ...
            SetWindowLongPtr(mainWindowHandle, GwlStyle, style);
            style = GetWindowLongPtr(mainWindowHandle, GwlExStyle);
            SetWindowLongPtr(mainWindowHandle, GwlExStyle, (IntPtr)((long)style | (long)WsExDlgModalFrame));
