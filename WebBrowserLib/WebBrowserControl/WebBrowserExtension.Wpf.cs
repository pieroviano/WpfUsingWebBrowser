...
namespace WebBrowserLib.WebBrowserControl
{
    public static partial class WebBrowserExtension
    {
        ...
        public static void AttachCustomFunctionOnDocument(this WebBrowser webBrowser, string eventName, Func<bool> codeToExecute,
            ...
            Action<CustomWebBrowserControlEventHandler> setCustomEventHandler)
        {
            ...
            webBrowser.AttachEventHandlerToDocument(eventName, codeToExecuteClass,
                codeToExecuteClass.CustomEventDelegate, functionHash,
                getCustomEventHandler, setCustomEventHandler);
        }

        public static void AttachCustomFunctionOnControl(this WebBrowser webBrowser, string controlId, string eventName, Func<bool> codeToExecute,
            int functionHash, Func<CustomWebBrowserControlEventHandler> getCustomEventHandler,
            Action<CustomWebBrowserControlEventHandler> setCustomEventHandler)
        {
            var codeToExecuteClass = new CodeToExecuteClass(codeToExecute);
            ...
            webBrowser.AttachEventHandlerToControl(controlId, eventName, codeToExecuteClass,
                codeToExecuteClass.CustomEventDelegate, functionHash,
                getCustomEventHandler, setCustomEventHandler);
        }
